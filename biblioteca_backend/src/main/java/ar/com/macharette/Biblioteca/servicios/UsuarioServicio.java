...
import ar.com.macharette.Biblioteca.enumeraciones.Rol;
import ar.com.macharette.Biblioteca.exepciones.MiException;
import ar.com.macharette.Biblioteca.repositorios.UsuarioRepositorio;
...
public class UsuarioServicio implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        ...
        if (usuario != null) {
            ...
            permisos.add(p);
            //recuperar los datos del usuario en contexto actual

            ServletRequestAttributes attr = (ServletRequestAttributes) RequestContextHolder.currentRequestAttributes();
            //guardar el llamado en session
            HttpSession session = attr.getRequest().getSession(true);
            //en los datos se seten los atributos (usuariosession llave, ususario valor usuario autenticado)
